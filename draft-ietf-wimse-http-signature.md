...
(and the receiver MUST verify) a Content-Digest header. This implies the received MUST compute the Content-Digest value for the message content received and compare it with the Content-Digest value provided in the message. 
...
To protect against message replays,
...
response), including the Request URI and the message content. This
